"""
Django settings for peak_college project.
...
ROOT_URLCONF = 'peak_college.urls'
...
WSGI_APPLICATION = 'peak_college.wsgi.application'
...
DEFAULT_FROM_EMAIL = 'Lchaim <lcahim@app.lchaimretirement.ca>'
